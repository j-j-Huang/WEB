document.addEventListener("DOMContentLoaded", function() {
    ...
    formulario.addEventListener("submit", function(event) {
        ...
        if (isNaN(edadNum) || edadNum <= 0 || edadNum > 120) {
            mensajeError.textContent = "La edad debe ser un número positivo y menor a 120 años.";
            return;
        }
        ...
        if (fechaNacimientoDate >= hoy) {
            mensajeError.textContent = "La fecha de nacimiento no puede ser una fecha futura.";
            return;
        }
